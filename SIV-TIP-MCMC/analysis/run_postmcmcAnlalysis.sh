#Neha Khetan, Dec 2022- July 2023 Bash script to automate all analysis runs across all the animals"""
...
for iS in $( eval echo "{1..$samNo}" )
	do	
		...
		python poolanalysisnRuns.py $iS $nRuns  $ipath  $opath 17500 20
